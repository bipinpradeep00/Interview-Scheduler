    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.SmallIntegerField(blank=True, choices=[(1, 'Male'), (2, 'Female'), (0, 'Others')], null=True)),
                ('role', models.SmallIntegerField(blank=True, null=True, verbose_name=((1, 'candidate'), (2, 'Interviewer'), (3, 'Admin')))),
